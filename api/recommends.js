import { fetchTMDB, getValidKRProviders, getTagsFromGenreIds } from '../src/services/server/mediaFetcher.js';
...
export default async function handler(req, res) {
  ...
  try {
    const list = await Promise.all(CURATED_RECOMMENDS.map(async (item) => {
      try {
    ...
    console.error("Recommends API Error:", error);
